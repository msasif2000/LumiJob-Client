  ...
  return (
    <section className="max-w-screen-2xl mx-auto px-4 lg:px-20 py-12">
      ...
      <div className="py-12 grid grid-cols-1 lg:grid-cols-2 gap-4 ">
        <div>
          <h4 className="text-3xl md:text-5xl 2xl:text-6xl font-heading font-semibold text-center lg:text-left">
            Navigating
        ...
        <div className="flex lg:justify-end items-center">
          <div className="w-full lg:w-3/4 text-center lg:text-left">
            <p className="text-[0.75rem] md:text-[1rem] xl:text-[1.15rem] 2xl:text-[1.25rem] text-gray-600">
