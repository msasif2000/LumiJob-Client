...
const TrustedByCompany = () => {
  ...
  return (
    <>
      <div className="w-full min-h-20 bg-gray-50 flex items-center py-6 px-4 lg:px-20">
        <div className="flex w-full flex-wrap items-center justify-center mx-auto">
          ...
          <div className="flex w-full flex-wrap  items-center justify-center gap-10 xl:gap-24 lg:gap-12">
