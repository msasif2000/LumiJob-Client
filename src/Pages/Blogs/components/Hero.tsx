    ...
    <div className="h-[440px] md:h-[560px] lg:min-h-screen bg-[#F2F8F5] relative overflow-hidden">
      <div className="max-w-screen-2xl mx-auto lg:px-4">
        <div className="space-y-10 lg:space-y-20 relative z-10">
          <h1 className="hidden xl:block text-[120px] font-bold pt-20 relative z-10">
            News, Seminars & <br /> Insides of Tech <br /> Fields.
          </h1>
          <h1 className="xl:hidden block text-3xl md:text-7xl px-3 font-bold pt-10 relative z-10">
            News, Seminars & <br /> Insides of Tech <br /> Fields.
          </h1>
          <img
            src={green}
          ...
          <p className="text-xs px-3 md:text-lg lg:px-0 lg:text-xl lg:font-bold relative z-10">
