...
const FindCandidateCard: React.FC<CandidateCardsProps> = ({ candidate }) => {
    ...
    return (
        <div className="">
            <div>
                <div className="group grid grid-cols-12 overflow-hidden rounded-lg border hover:border-accent py-2 text-gray-700 bg-white ">
                    <div className="order-2 col-span-2 -ml-14 text-left text-gray-600 hover:text-gray-700 sm:-order-1 sm:ml-4">
                        <div className="group relative h-16 w-16 overflow-hidden rounded-lg">
                            <img src={photo} alt="logo" className="w-full  text-gray-700" />
                        </div>
                    </div>
                    <div className="col-span-7 flex flex-col pr-8 text-left sm:pl-4">
