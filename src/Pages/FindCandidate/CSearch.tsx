            ...
            <form>
                <div className="flex items-center justify-center p-5">
                    <div className="border-2 w-11/12 rounded-tr-lg rounded-br-lg">
                        <div className="flex">
                            <div className=" hidden md:flex w-10 items-center justify-center rounded-tl-lg rounded-bl-lg border-r border-gray-200 bg-white p-5">
                            ...
                            <input
                                ...
                                placeholder="name, post, skill..."
                            />
                            <button
                                onClick={handleSearch}
                                className="bg-blue-500 px-2 md:px-10 md:py-2 md:rounded-tr-lg md:rounded-br-lg text-white font-semibold hover:bg-blue-800 transition-colors
