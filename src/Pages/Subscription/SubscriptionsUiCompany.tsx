          ...
          <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border-2 scale-100 border-gray-100   xl:p-8 ">
              ...
              <p className="font-light text-gray-500 sm:text-lg ">
                Your essential toolkit for job hunting. Access diverse job
                listings and apply seamlessly.
              </p>
              ...
              <ul role="list" className="mb-8 space-y-4 text-left">
                <li className="flex items-center space-x-3">
                  ...
                  <span>
                    Limited to <span className="text-lg font-semibold">3</span>{" "}
                    active job listings at a time
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  {/* Icon */}
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>Standard support via email.</span>
                </li>
              </ul>
            ...
            <div className="flex flex-col p-6 mx-auto max-w-lg text-center relative text-gray-900 bg-white rounded-lg border-2 scale-110 border-gray-100 xl:p-8 ">
              ...
              <ul role="list" className="mb-8 space-y-4 text-left">
                <li className="flex items-center space-x-3">
                  ...
                  <span>
                    Up to <span className="text-lg font-semibold">20</span>{" "}
                    active job listings at a time
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span>
                    Advanced application tracking with filtering and sorting
                    options
                  </span>
                </li>
              </ul>
