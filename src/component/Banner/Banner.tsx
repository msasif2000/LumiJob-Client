        ...
        <div className="max-w-screen-2xl mx-auto lg:px-4">
          <div className="relative z-30">
            <div className="space-y-4 lg:space-y-5 xl:space-y-8  text-center">
              <h1 className="hidden xl:block text-5xl font-bold  xl:pt-20 relative z-30">
                Grow With Us <br /> And build Your
                Career
              </h1>
              <h1 className="xl:hidden block text-3xl md:text-5xl pt-5 lg:pt-8 px-3 font-bold  relative z-30">
                Grow With Us <br /> And build Your
                Career
              </h1>
              <h1 className=" text-sm md:text-base lg:text-lg xl:text-xl text-gray-600 px-5 md:px-28 lg:px-40 font-bold relative z-30">
