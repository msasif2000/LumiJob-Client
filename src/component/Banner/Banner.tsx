  ...
  return (
    <section className="bg-white bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:36px_36px] -mt-16">
      <div className="max-w-screen-xl mx-auto px-4 py-10 relative">
        ...
        >
          <h2 className="text-[#3F3F46] text-[1.4rem] md:text-[2.3rem] lg:text-[3rem] xl:text-[3.5rem] 2xl:text-[4.3rem] font-heading font-semibold my-12 z-10 flex flex-wrap items-center justify-center">
            Empowering
            <img
              src={empowering}
              alt="Empowering"
