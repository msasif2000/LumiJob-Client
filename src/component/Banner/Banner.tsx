                    ...
                    <div className="flex px-10 lg:px-0 justify-between flex-col-reverse md:flex-row items-center ">
                        ...
                        <div className="flex-1 relative">
                            ...
                            <div className="absolute bottom-0 lg:bottom-20 right-1 bg-white rounded-xl drop-shadow-xl p-4 w-[205px] md:w-[260px] lg:w-[300px]">
                                ...
                                <p className="md:text-xs lg:text-base text-gray-600 pt-2 hidden md:flex md:flex-col">Online social networking and micro-blogging service that...<NavLink className="text-blue-700 text-xs lg:text-base font-semibold" to="/">Read more</NavLink> </p>
                                <div className="mt-3">
                                    <button className="btn btn-sm bg-blue-100 p-[5px] md:p-3 lg:p-3 text-[11px] md:text-[12px]  text-blue-900 normal-case">Fulltime</button>
                                    <button className="btn btn-sm bg-green-10 p-[5px] md:p-3 lg:p-3 text-[11px] md:text-[12px] text-green-800 normal-case mx-1 lg:mx-3">Remote</button>
                                    <button className="btn btn-sm bg-fuchsia-100 p-[5px] md:p-3 lg:p-3 text-[11px] md:text-[12px] text-fuchsia-800 normal-case">Anywhere</button>
                                </div>
                            </div>
                        </div>
                    </div>
