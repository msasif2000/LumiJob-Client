    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <div className="max-w-3xl mx-auto">
                ...
                <div>
                    <h3 className="text-xl font-bold mb-2"><FaBriefcase className="inline-block mr-2" /> Job Posting & Management</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaUserFriends className="inline-block mr-2" /> Candidate Search & Sourcing</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaBullhorn className="inline-block mr-2" /> Employer Branding</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaSearch className="inline-block mr-2" /> Advanced Job Filtering</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaChartLine className="inline-block mr-2" /> Personalized Dashboard</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaCalendarAlt className="inline-block mr-2" /> Application Tracking</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaCommentAlt className="inline-block mr-2" /> Interview Scheduling</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold mb-2"><FaStar className="inline-block mr-2" /> Feedback and Ratings</h3>
                    <p className="mb-4">
