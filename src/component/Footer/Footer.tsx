...
const Footer = () => {
  return (
    <div className="relative mt-16 bg-gray-300">
      <footer className="footer py-10 px-4 max-w-screen-2xl mx-auto grid grid-cols-2 md:grid-cols-4 font-semibold">
        <div>
        ...
        <div>
          ...
          <Link className="link link-hover" to="/" target="_blank">
            Portfolio
          </Link>
          <Link target="_blank" className="link link-hover" to="/">
            Github
          </Link>
          <Link className="link link-hover" to="/" target="_blank">
            Linkedin
      ...
      <div className="max-w-screen-2xl mx-auto px-4 pb-4 bg-gray-300">
