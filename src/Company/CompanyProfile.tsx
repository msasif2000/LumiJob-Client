      ...
      <div className="">
        <div className="md:h-60 mt-10 px-7 bg-gradient-to-r from-[#228bedde] to-[#6565C7]">
          <div className="flex justify-between items-center my-2 pt-2">
            <div>
              <p className="text-xl md:text-2xl p-2 text-white ">
                Company Profile
              </p>
            </div>
          ...
          <div className="md:flex md:gap-10">
            ...
            <div className="md:flex mt-5 md:mt-0 md:gap-10">
              <div>
                <p className="text-sm md:text-base font-semibold uppercase text-white ">
                  Location
                </p>
                <p className="text-sm md:text-lg  text-white ">
                  {profile?.city} - {profile?.postal}, {profile?.country}
                </p>
                <p className="text-sm md:text-base uppercase text-white pt-1">
                  Phone: {profile?.phone}
                </p>
                <p className=" text-sm md:text-base text-white md:pt-1">
                  E-mail: {profile?.email}
                </p>
              </div>
              <div>
                <p className="text-sm md:text-base font-semibold uppercase text-white mt-1 md:mt-2 ">
                  Website
                </p>
                <p className="text-sm md:text-lg  text-white ">
                  {profile?.website}
