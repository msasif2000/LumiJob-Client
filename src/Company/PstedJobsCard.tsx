...
const PostedJobsCard = () => {
  ...
  return (
    <div className="card w-full bg-slate-100 border rounded-md ">
      {/*================ >> Content Box <<=============== */}
    ...
    ></path>
      ...
      <div className="py-4 px-10 space-y-3" >
        <div>
            ...
            <p>We are a creative powerhouse within the fintech industry, crafting user-centric experiences to redefine digital design. Rooted in innovation, we seek a UI Designer to join our dynamic team at the forefront of transforming financial advisory interfaces. Embrace the opportunity to blend artistry with technology in a collaborative and cutting-edge environment.</p>
        </div>
        <div>
            <h1 className="text-2xl font-semibold " >skills</h1>
            <li>Proven experience as a UI Designer with a strong portfolio showcasing design proficiency.</li>
            <li>Expertise in design tools such as Adobe XD, Sketch, or Figma.</li>
            <li>Contribute to the creation and maintenance of design systems for consistent user experiences.</li>
            <li>Lead the design and implementation of user interfaces for our financial advisory software.</li>
        </div>
        <div>
            <h1 className="text-2xl font-semibold " >responsibilities</h1>
            <li>Lead the design and implementation of user interfaces for our financial advisory software.</li>
            <li>Collaborate with development teams to ensure the alignment of visual design intent with technical feasibility.</li>
            <li>Contribute to the creation and maintenance of design systems for consistent user experiences.</li>
            <li>Lead the design and implementation of user interfaces for our financial advisory software.</li>
        </div>
        <div>
            <h1 className="text-2xl font-semibold " >Featured benefits</h1>
            <p>Competitive salary and benefits package.,
      Opportunity to contribute to revolutionary fintech design.,
