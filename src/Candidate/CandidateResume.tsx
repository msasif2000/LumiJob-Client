                ...
                <div className="border-2 p-16">
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            {designation ? <p className="text-[1.5rem]">{designation}</p> : null}
                        </div>
                        <div>
                            {
                                photo ? <div className="avatar">
                    ...
                    <div className="w-full flex pt-16">
                        ...
                        <div className="w-1/3">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="space-y-10">
                                    ...
                                    {/* Skills section */}
                                    <div>
                                        {skills?.length ? <div className="space-y-3">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {link.map((link, index) =>
                                                <div className="space-y-1" key={index}>
                                                    <a className="font-semibold text-violet-400 underline" href={link.link}>{link.name}</a>
                        ...
                        <div className="w-2/3">
                            ...
                            <div className="space-y-10">
                                {/* Objective */}
                                {objective ? <div className="space-y-3">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        {experienceDetails.map((experience, index) =>
                                            <div key={index}>
                                                ...
                                                <p>{experience?.fromDate?.slice(0, 10)} - {experience?.toDate?.slice(0, 10)}</p>
                                    ...
                                    {/* exp1 */}
                                    {
                                        project.map((proj, index) =>
                                            <div key={index}>
                                                ...
                                                <div className="my-4">
                                                    <a href={proj.link} className="font-semibold text-violet-400 underline">
                                                        Github
                                                    </a>
                                ...
                                {/* Education */}
                                {education ? <div className="space-y-4">
                                    <p className="text-[1.5rem] font-semibold">Education</p>
                                    {
                                        education.map((edu, index) =>
                                            <div key={index}>
                                                ...
                                                <p>{edu?.fromDate?.slice(0, 10)} - {edu?.toDate?.slice(0, 10)}</p>
                                            </div>
                                        )}
                                </div> : null}
                            </div>
